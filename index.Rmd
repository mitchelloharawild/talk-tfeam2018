...
look at the axis, source of many questions/complaints.
...
```{r reconciliation-example, echo = TRUE}
all_ets
```

???

batch forecasting is a natural match for forecast reconciliation
there are early plans to support forecast reconciliation with the reconcile() function
