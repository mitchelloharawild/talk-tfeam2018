...
tsibbledata::elecdemand %>% 
  fable::ARIMA(
    Demand ~ pdq(1,1,0) + PDQ(2,0,2, period = "day") + WorkDay + Temperature + I(Temperature^2))
```
...
forecast::Arima(ts(fpp2::elecdemand[,"Demand"], frequency = 48), order = c(1,1,0), seasonal = c(2,0,2))

auto.arima(ts(fpp2::elecdemand[,"Demand"], frequency = 48),
           xreg = cbind(fpp2::elecdemand[,c("WorkDay", "Temperature")], fpp2::elecdemand[,"Temperature"]^2))
```
]
]
